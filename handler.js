...
/* Creditos a Otosaka (https://wa.me/51935763050) */	
...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ✍;;;\nFN:𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ✍\nORG:𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ✍\nTITLE:\nitem1.TEL;waid=51929741688+51 929 741 688\nitem1.X-ABLabel:𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ✍\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ✍\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ✍', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: 'Mateo Bot' , thumbnail: imagen1, sourceUrl: 'https://instagram.com/mateo_ventas_?igshid=NTc4MTIwNjQ2YQ==' }}}}, aa)
