...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: '𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭' , thumbnail: imagen1, sourceUrl: 'https://instagram.com/mateo_ventas_?igshid=NTc4MTIwNjQ2YQ==' }}}}, aa)
